      ...
      <main>
        <article className="relative overflow-hidden">
          <header className="relative overflow-hidden pb-12 pt-32 sm:pb-16 sm:pt-36">
            ...
            <div className="relative z-10 mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.55fr_0.45fr] lg:items-center lg:px-8">
              <div>
                <a
                  href="/articles/"
              ...
              <figure className="overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/50 shadow-2xl shadow-slate-950/40">
                <img
          ...
          <div className="bg-slate-950 pb-16 sm:pb-20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid gap-8 xl:grid-cols-[14rem_minmax(0,1fr)] xl:items-start">
                <aside className="hidden xl:block">
                  <nav className="sticky top-28 rounded-3xl border border-slate-800 bg-slate-900/35 p-5" aria-label="Содержание статьи">
                    ...
                    <ul className="mt-4 space-y-2.5">
                      ...
                      <li>
                        <a href="#comparison" className="block rounded-xl px-3 py-2 text-sm leading-snug text-slate-400 transition-colors hover:bg-slate-800/70 hover:text-indigo-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300/70">
                          Сравнение
                        </a>
                      </li>
                      <li>
                        <a href="#decision-questions" className="block rounded-xl px-3 py-2 text-sm leading-snug text-slate-400 transition-colors hover:bg-slate-800/70 hover:text-indigo-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300/70">
                          Как принять решение
                        </a>
                      </li>
                      <li>
                        <a href="#conclusion" className="block rounded-xl px-3 py-2 text-sm leading-snug text-slate-400 transition-colors hover:bg-slate-800/70 hover:text-indigo-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300/70">
                          Вывод
                        </a>
                      </li>
                    </ul>
                ...
                <div className="overflow-hidden rounded-[2.25rem] border border-white/10 bg-[radial-gradient(circle_at_18%_0%,rgba(34,211,238,0.08),transparent_34%),linear-gradient(180deg,rgba(15,23,42,0.82),rgba(2,6,23,0.92))] p-5 shadow-2xl shadow-slate-950/30 sm:p-8 lg:p-10">
                    ...
                    {article.sections.map((section) => (
                      <section key={section.id} id={section.id} className="scroll-mt-28">
                        ...
                        {article.callouts
                          ...
                          .map((callout) => (
                          <aside key={`${section.id}-${callout.title}`} className={`mt-8 rounded-[1.75rem] border p-5 sm:p-6 ${
