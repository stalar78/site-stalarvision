        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-2">
          {trustSection.clientRecommendations.map((recommendation, index) => (
            <motion.article
              ...
              className={`overflow-hidden rounded-3xl border border-cyan-300/18 bg-[radial-gradient(circle_at_14%_0%,rgba(34,211,238,0.1),transparent_34%),linear-gradient(135deg,rgba(15,23,42,0.82),rgba(2,6,23,0.92))] p-5 sm:p-6 ${trustSection.clientRecommendations.length % 2 === 1 && index === 0 ? 'lg:col-span-2' : ''}`}
            >
