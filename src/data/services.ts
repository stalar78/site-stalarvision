...
export const servicesSection = {
  ...
  description:
    'Чаще всего ко мне приходят с пятью типами задач: новый проект, доработка действующего решения, аудит перед изменениями, рабочие интерфейсы и личные кабинеты, а также интеграции и автоматизация. Обычно начинаем с короткого обсуждения и определения первого этапа.',
  items: [
    {
