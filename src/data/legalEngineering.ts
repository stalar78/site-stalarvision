...
export const legalEngineeringPage: LegalEngineeringPageData = {
  ...
  hero: {
    ...
    description:
      'Помогаю разрабатывать цифровые продукты и разбирать уже работающие системы: от аудита, Legal by Design и IT-договоров до претензий, споров и взаимодействия с контрольными и надзорными органами.',
    note:
  ...
  professionalBasis: {
    ...
    items: [
      'Юридическое образование: МГЮА',
      'Практическая юридическая работа и представительство в суде',
      'Практическая full-stack разработка',
    ],
    note: 'Legal Engineering вырос из соединения юридической практики и разработки: поэтому правовые вопросы рассматриваются вместе с тем, как продукт устроен и работает.',
  },
  contours: {
    id: 'contours',
    title: 'Два контура одной задачи',
    description: 'Цифровой продукт можно сопровождать на этапе проектирования и защищать, когда уже возник спорный вопрос.',
    items: [
      {
        eyebrow: 'PREVENT / ENGINEER',
        title: 'Legal Engineering цифрового продукта',
        description: 'Проверяю и проектирую связь между правовыми требованиями и технической реализацией продукта.',
        items: ['Аудит документов, форм и согласий', 'Персональные данные и data flow', 'API, backend и инфраструктура', 'Legal by Design', 'Сопоставление документов и реализации', 'Технические исправления, если они входят в согласованный scope'],
        cta: 'Обсудить задачу',
        href: '/#contact',
      },
      {
        eyebrow: 'PROTECT / RESOLVE',
        title: 'IT-право и защита интересов',
        description: 'Помогаю разобраться в договорной и спорной части цифрового проекта, включая подготовку позиции и взаимодействие с другой стороной.',
        items: ['IT-договоры и анализ договорных рисков', 'Претензионная работа', 'Контрольные и надзорные органы', 'IT-споры и представительство', 'Судебное сопровождение цифровых споров', 'Представительство в предусмотренных законом случаях'],
        cta: 'Обсудить правовую задачу',
        href: '/#contact',
      },
    ],
  },
  linkage: {
    id: 'technical-legal-linkage',
    title: 'В цифровом споре недостаточно прочитать только договор',
    description: 'Нужно понимать код, API, инфраструктуру и пользовательский сценарий. И наоборот: при разработке недостаточно написать код, если архитектура создаёт договорные или регуляторные последствия.',
  },
  architectures: {
    id: 'architectures',
  ...
  clientProofSection: {
    ...
    items: [
      {
        id: 'mychko',
        company: 'ИП Мычко Павел Андреевич',
        eyebrow: 'ПОДТВЕРЖДЕНО КЛИЕНТОМ',
        compactEyebrow: 'LEGAL ENGINEERING · РЕКОМЕНДАЦИЯ КЛИЕНТА',
        author: 'Мычко Павел Андреевич',
        role: 'Индивидуальный предприниматель',
        quote:
          '«Особенно отмечаем комплексный подход, при котором вопросы разработки рассматриваются не только с технической, но и с правовой точки зрения.»',
        note:
          'В рамках консультации были рассмотрены требования к будущему сайту, его структура и функционал, размещение информации, обработка персональных данных, формы обратной связи и юридико-технические аспекты запуска проекта. Полученные рекомендации помогли сформулировать требования к будущему сайту и определить направления дальнейшей разработки.',
        image: '/legal-engineering/mychko-recommendation.jpg',
        imageAlt: 'Благодарственное письмо ИП Мычко Павла Андреевича по консультации о подготовке и разработке сайта',
        openLabel: 'Открыть благодарственное письмо',
        openAriaLabel: 'Открыть оригинал благодарственного письма ИП Мычко Павла Андреевича',
    ...
    items: [
      {
        title: 'IT-договоры',
        description:
          'Анализирую договоры на разработку и поддержку, технический scope и условия, которые определяют ожидания и риски сторон.',
      },
      {
        title: 'Претензионная работа',
        description:
          'Помогаю собрать фактическую техническую картину и подготовить позицию по вопросам результата, сроков, доступа, поддержки или передачи проекта.',
      },
      {
        title: 'Контрольные и надзорные органы',
        description:
          'Сопровождаю взаимодействие по цифровым и IT-вопросам, когда для ответа нужно связать документы с фактической работой системы.',
      },
      {
        title: 'IT-споры и представительство',
        description:
          'Разбираю технические обстоятельства IT-спора и оказываю судебное сопровождение и представительство в предусмотренных законом случаях.',
      },
    ],
  },
  partnerFormat: {
