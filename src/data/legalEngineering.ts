...
export const legalEngineeringPage: LegalEngineeringPageData = {
  ...
  clientProofSection: {
    ...
    items: [
      {
        id: 'tdn',
        company: 'АО «Торговый дом недвижимости»',
        eyebrow: 'ПОДТВЕРЖДЕНО КЛИЕНТОМ',
        compactEyebrow: 'LEGAL ENGINEERING · РЕКОМЕНДАЦИЯ КЛИЕНТА',
        author: 'А.В. Ежов',
        role: 'Генеральный директор',
        quote:
          '«Такой формат оказался полезен именно тем, что позволяет посмотреть на сайт одновременно с юридической и технической стороны и увидеть вопросы, которые при раздельной работе юриста и разработчика могут оставаться между зонами их ответственности.»',
        note:
          'По результатам юридико-технического аудита сайта an-tdn.ru клиент получил структурированный отчёт, в котором наблюдения были отделены от предположений и вопросов, требующих дополнительной внутренней проверки. В благодарственном письме также отмечены аккуратный подход к оценке рисков, обозначение оснований и уровня подтверждённости выводов, а также практические рекомендации по устранению и дальнейшей проверке выявленных вопросов.',
        image: '/legal-engineering/tdn-recommendation.jpg',
        imageAlt: 'Благодарственное письмо АО «Торговый дом недвижимости» по результатам юридико-технического аудита сайта an-tdn.ru',
        openLabel: 'Открыть благодарственное письмо',
        openAriaLabel: 'Открыть оригинал благодарственного письма АО «Торговый дом недвижимости»',
