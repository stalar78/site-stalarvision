...
import { getClientProofMetadata, legalEngineeringPage } from '@/data/legalEngineering';
...
export const heroSection = {
  ...
  title: {
    lead: 'Разработка и Legal Engineering',
    accent: 'цифровых решений',
    tail: 'для бизнеса и рабочих процессов',
  },
  description:
    'Сайты, веб-интерфейсы, прикладное ПО, автоматизация и аудит — от технического состояния до юридико-технической архитектуры, обработки данных, API и инфраструктуры.',
  actions: {
    primary: {
  ...
  highlights: [
    { icon: Rocket, text: 'Разработка и запуск' },
    { icon: Zap, text: 'Доработка и автоматизация' },
    { icon: Search, text: 'Технический / Legal Engineering аудит' },
  ...
  terminal: {
    ...
    commands: [
      ...
      },
      {
        ...
        command: 'legal-engineering',
        scenario: 'юридико-технический разбор',
        start: 'сопоставление документов и фактической архитектуры',
        output: [
          'схема движения данных',
          'согласия и документы',
          'API / backend / хранение',
          'юридико-технические расхождения',
  ...
  panelSummary: {
    items: [
      ...
      { label: 'Сценарий', value: 'Разработка / аудит / Legal Engineering' },
    ],
    note:
      'Можно прийти с новой задачей, действующим проектом или запросом на технический либо юридико-технический разбор перед изменениями.',
  },
  floatingCards: {
    conversion: {
      label: 'Формат работы',
...
export const trustSection = {
  ...
  clientRecommendations: legalEngineeringPage.clientProofSection.items.map((clientProof) => ({
    ...clientProof,
    metadata: getClientProofMetadata(clientProof),
    legalEngineeringHref: legalEngineeringPage.seo.path,
  })),
  summary:
