...
export const heroSection = {
  ...
  title: {
    ...
    accent: 'для нового сайта, доработки или технического разбора',
    tail: 'с понятным первым шагом',
  },
  description:
    'Работаю напрямую. Помогаю запустить новый сайт, доработать существующий проект или разобраться в текущем состоянии. Начинаем с понятного первого этапа.',
  actions: {
    primary: {
