...
export const heroSection = {
  ...
  title: {
    ...
    accent: 'для нового проекта, доработки и аудита',
    tail: 'с понятным первым шагом',
  },
  description:
    'Сюда можно прийти с новым проектом, доработкой действующего решения или запросом на аудит / технический разбор. На старте достаточно коротко описать задачу и контекст, чтобы спокойно определить первый рабочий этап.',
  actions: {
    primary: {
      label: 'Начать с короткого обсуждения',
      href: '/#contact',
    },
    secondary: {
