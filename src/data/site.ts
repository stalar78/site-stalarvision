...
export const heroSection = {
  ...
  description:
    `${profile.owner.name}, ${profile.brand.fullName}. ${profile.positioning.heroSupport} Работаю напрямую с бизнесом, экспертами и небольшими командами: можно прийти с новым проектом или с доработкой того, что уже работает.`,
  actions: {
    primary: {
      label: profile.ctas.breakDownTask,
      href: '/#contact',
...
export const aboutSection = {
  ...
  paragraphs: [
    `${profile.owner.name} подключается там, где нужен один сильный технический исполнитель: запустить сайт, собрать интерфейс, автоматизировать часть процесса или спокойно развивать существующий проект.`,
    profile.workFormat.summary,
    `Такой формат удобен, когда важно обсуждать задачу напрямую, не терять контекст по дороге и быстрее переходить к первому рабочему этапу.`,
  ],
  stats: [
...
export const techStackSection = {
  ...
  description:
    'Стек подбирается под задачу, а не ради витрины технологий. Основной фокус — современные frontend- и backend-инструменты, с которыми проект удобно запускать, поддерживать и развивать дальше.',
...
export const footerData = {
  ...
  description:
    'Независимый разработчик для бизнеса: сайты, веб-приложения, автоматизация и развитие существующих проектов.',
