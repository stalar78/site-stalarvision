...
export const heroSection = {
  ...
  description:
    'Сайты, веб-интерфейсы, прикладное ПО и автоматизация под конкретные задачи. Работа строится напрямую: от технического разбора и проектирования первого этапа до реализации, запуска и дальнейшего развития решения.',
  actions: {
    primary: {
