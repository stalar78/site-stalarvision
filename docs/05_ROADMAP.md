...
2. Использовать `contact_form_success` как основную цель заявки в отчётах и будущих рекламных кампаниях.
3. Использовать именованные цели Telegram, MAX, email и телефона для анализа каналов связи.
