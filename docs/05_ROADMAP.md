...
- блоки с `lg:grid-cols-5` нужно визуально контролировать на ширине около 1280 px.

## Следующие шаги

1. Провести ручной production QA `/razrabotka-sajta/` на 390 px, около 1280 px и полном desktop.
2. Отправить `https://stalarvision.ru/razrabotka-sajta/` на индексирование Google.
3. После появления страницы в индексе проверить Google-selected canonical.
4. Добавить сайт и три service pages в Яндекс Вебмастер и проверить индексирование.
5. Настроить цели Яндекс Метрики для заявок и ключевых CTA.
6. Провести инвентаризацию реальных проектов для будущих кейсов.
7. Отдельно разобрать dependency audit без `--force`.
